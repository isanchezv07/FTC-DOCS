...
- Aquí se inicializan los motores y otros dispositivos.
...
<Badge text="El signo negativo (-) es necesario porque en FTC el joystick está invertido por defecto." variant="note" style={{ fontStyle: 'italic' }} />
